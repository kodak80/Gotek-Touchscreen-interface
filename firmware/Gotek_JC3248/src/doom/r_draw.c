...
byte           *gti_byte_tempbuf;   /* GTi: heap */
#define byte_tempbuf gti_byte_tempbuf

unsigned short *gti_short_tempbuf;
#define short_tempbuf gti_short_tempbuf

unsigned int   *gti_int_tempbuf;
#define int_tempbuf gti_int_tempbuf
