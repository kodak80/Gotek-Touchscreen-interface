...
int *floorclip, *ceilingclip;   /* GTi: heap */ // dropoff overflow

// spanstart holds the start of a plane span; initialized to 0 at start

int *gti_spanstart;   /* GTi: heap */
#define spanstart gti_spanstart
                // killough 2/8/98
...
fixed_t *gti_cachedheight;
#define cachedheight gti_cachedheight

fixed_t *gti_cacheddistance;
#define cacheddistance gti_cacheddistance

fixed_t *gti_cachedxstep;
#define cachedxstep gti_cachedxstep

fixed_t *gti_cachedystep;
#define cachedystep gti_cachedystep

static fixed_t xoffs,yoffs;    // killough 2/28/98: flat offsets

fixed_t *yslope, *distscale;   /* GTi: heap */
...
void R_ClearPlanes(void)
{
  ...
  // texture calculation
  memset (cachedheight, 0, MAX_SCREENHEIGHT*sizeof(*cachedheight));
